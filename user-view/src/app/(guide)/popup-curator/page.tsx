  ...
  return (
    <div className="screen" style={{ background: "var(--bg)", height: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <header style={{
        ...
        <p className="t-micro" style={{ marginBottom: 2 }}>어비스 티 라운지</p>
        <h1 className="t-title" style={{ fontSize: 18 }}>다시 만나서 반가워요 👋</h1>
      </header>
        ...
        {selectedZone && (
          <div className="anim-up" style={{
            ...
            <p className="t-body" style={{ fontSize: 13.5, lineHeight: 1.7, color: "var(--ink-2)", marginBottom: "var(--space-4)" }}>
              ...
              이곳 {selectedZone.name}에 시각적 향과 티 블렌딩으로 연장하여 담아냈습니다.
            </p>
